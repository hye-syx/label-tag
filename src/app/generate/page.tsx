...
export default function GeneratePage() {
  ...
  return (
    <div className="flex h-screen w-screen p-5 gap-5 bg-gray-100">
      {/* 左侧：操作区域 - 65% */}
      <div className="w-[65%] bg-white shadow-lg flex flex-col p-5 overflow-y-auto">
        {/* 标题 */}
        <div className="flex items-end justify-between mb-5">
          <h1 className="text-xl font-bold">生成标签设置</h1>
